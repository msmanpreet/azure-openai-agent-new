...
def analyze_user_input(user_input: str, history: List[Dict[str, str]]) -> Dict:
    ...
    # Include last N turns of context
...
def handle_chat(request: UserRequest):
    ...
    # If intent changed, reset parameters
    ...
    # Dispatch based on current intent and parameters
    if intent == Intent.account_config:
        ...
        msg = "I'm not sure what you're asking. Could you please rephrase or clarify?"
